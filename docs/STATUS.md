...
- 테스트 **375 케이스 / 38 파일** — 스토어 단위 + REST 계약 + Testing Library 통합(App 전체 마운트)
...
해결(Resolution)은 완료했다(2026-08-29, 서버 V6 포함). 버전/릴리스도 완료했다(2026-08-30, 서버 V7 포함). 첨부파일도 완료했다(2026-08-30, 서버 V8 + MinIO).
